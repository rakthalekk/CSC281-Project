...
"Good work! You've completed the tutorial!\n\nThere are two other available structures: the Healing Tower and the Bear Trap. The Healing Tower will heal you and your structures every few seconds, and the Bear Trap will catch any enemy that walks into it.\n\nYou can re-activate this spawner by pressing E on it. Feel free to experiment with the structures, and click Finish when you are ready to move on."]
